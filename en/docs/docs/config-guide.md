...
## 1.2. Configuring Periodic State Persistence
...
### 1.2.2. Persistence on File System
...
## 1.3. Configuring Siddhi Elements
...
### 1.3.1. Configuring Sources, Sinks and Stores References
...
### 1.3.2. Configuring Extensions System Parameters
...
### 1.3.3. Configuring Siddhi Properties
...
## 1.4. Configuring Authentication
...
## 1.5. Adding Extensions and Third Party Dependencies
...
### 1.5.1. Adding to Siddhi Java Program
...
### 1.5.2. Adding to Siddhi Local Microservice
...
### 1.5.3. Adding to Siddhi Docker Microservice
...
### 1.5.4. Adding to Siddhi Kubernetes Microservice
...
## 1.7. Converting Jars to OSGi Bundles
...
## 1.8 Encrypt sensitive deployment configurations
...
|masterKeyReader > parameters > masterKeyReaderFile| ${SIDDHI_RUNNER_HOME}/conf/runner/master-keys.yaml
| Location of `master-keys.yaml` file which contains password used to access the key store to decrypt the ancrypted passwords at runtime|
